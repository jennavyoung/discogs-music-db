...
\restrict F49128q8GQqc67MxfuQH9J0X1FXWBrorKTwOLlEJxvbrPUKRv90xSfetcJ7KJwe
...
--
-- Name: release_track_idx_title; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX release_track_idx_title ON public.release_track USING btree (title);
...
--
-- Name: release_artist release_artist_fk_artist; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.release_artist
    ADD CONSTRAINT release_artist_fk_artist FOREIGN KEY (artist_id) REFERENCES public.artist(id);
...
--
-- Name: release_company release_company_fk_company; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.release_company
    ADD CONSTRAINT release_company_fk_company FOREIGN KEY (company_id) REFERENCES public.label(id);
...
--
-- Name: release_track_artist release_track_artist_fk_artist; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.release_track_artist
    ADD CONSTRAINT release_track_artist_fk_artist FOREIGN KEY (artist_id) REFERENCES public.artist(id);
...
\unrestrict F49128q8GQqc67MxfuQH9J0X1FXWBrorKTwOLlEJxvbrPUKRv90xSfetcJ7KJwe
